...
-- LESSON ---------------------------------------------------------------------------
-- -------------------------------------------------------------------------
INSERT INTO public.lesson (id, name, content, ordinal_number, topic_id, node_id) VALUES (1, 'First source code', 'When you want to write your program in C you have to write so called ''main'' function.
...
', 1, 1, 1);
INSERT INTO public.lesson (id, name, content, ordinal_number, topic_id, node_id) VALUES (2, 'Header files', 'A header file is a file with extension .h which contains declarations and definitions to be shared between several source files. There are two types of header files: the files that the programmer writes and the files that comes with your compiler.
...
', 2, 1, 2);
INSERT INTO public.lesson (id, name, content, ordinal_number, topic_id, node_id) VALUES (3, 'Common simple input/output', 'Almost every program needs to input some values and output results. So we have to use appropriate commands for it.
...
#include &lt;iostream&gt;
', 4, 1, 4);
INSERT INTO public.lesson (id, name, content, ordinal_number, topic_id, node_id) VALUES (5, 'Simple input and output in C++', 'As mentioned earlier, cin and cout are available for input and output. Their use is supplemented by a special operator ''&lt;&lt;'' and ''&gt;&gt;''. Multiple items can be read or written with one cin command and one cout command. Small hint: Operator ''&gt;&gt;'' points from cin to the variable, operator ''&lt;&lt;'' points from variable or expression to cout. For example input to two variables:
cin &gt;&gt; Var1 &gt;&gt; Var2;
...
', 5, 1, 5);
INSERT INTO public.lesson (id, name, content, ordinal_number, topic_id, node_id) VALUES (6, 'What is a variable?', 'A variable is certain place in computer memory which can hold some values. It""s different approach than in mathematics.
...
', 6, 1, null);
INSERT INTO public.lesson (id, name, content, ordinal_number, topic_id, node_id) VALUES (7, 'Values of variable', 'Each variable can hold some values. Because the variable occupies certain space in the computer""s memory, which is composed as a sequence of bits, each value is machine-displayed as a sequence of zeros and ones.
...
-- NODE
-- -------------------------------------------------------------------------
INSERT INTO public.node (id, pretest_id, lesson_id, question_depth, level_depth, walk_through, successfully_completed, level) VALUES (1, 1, 1, 0, 0, false, false, 1);
INSERT INTO public.node (id, pretest_id, lesson_id, question_depth, level_depth, walk_through, successfully_completed, level) VALUES (2, 2, 2, 0, 0, false, false, 2);
INSERT INTO public.node (id, pretest_id, lesson_id, question_depth, level_depth, walk_through, successfully_completed, level) VALUES (3, 3, 3, 0, 0, false, false, 3);
INSERT INTO public.node (id, pretest_id, lesson_id, question_depth, level_depth, walk_through, successfully_completed, level) VALUES (4, 3, 4, 0, 0, false, false, 4);
INSERT INTO public.node (id, pretest_id, lesson_id, question_depth, level_depth, walk_through, successfully_completed, level) VALUES (5, 4, 5, 0, 0, false, false, 5);
...
-- QUESTION
-- -------------------------------------------------------------------------
INSERT INTO public.question (id, text, points, number, question_type, lesson_id, ordinal_number) VALUES (1, 'Parameters of the main function are enclosed by:', 1, 1, 0, 1, 0);
INSERT INTO public.question (id, text, points, number, question_type, lesson_id, ordinal_number) VALUES (2, 'The header file is:', 1, 1, 0, 1, 0);
INSERT INTO public.question (id, text, points, number, question_type, lesson_id, ordinal_number) VALUES (3, 'The header file to come with compiler or operating system is used to write:', 1, 2, 0, 2, 0);
INSERT INTO public.question (id, text, points, number, question_type, lesson_id, ordinal_number) VALUES (4, 'The header file written by programmer is used to write', 1, 3, 0, 2, 0);
INSERT INTO public.question (id, text, points, number, question_type, lesson_id, ordinal_number) VALUES (5, 'Assume the following variable declarations:
   <font face=''code''>double A, B = 0;
   float C, D=1.2E-2;</font>
How much total memory do these variables take?', 2, 4, 2, 3, 0);
INSERT INTO public.question (id, text, points, number, question_type, lesson_id, ordinal_number) VALUES (6, 'The main function represents [[1]] of C-program. Its declaration consists of [[2]] type, identifier "main", parameters and body. The body of main function contains statement for [[3]].', 2, 5, 1, 3, 0);
INSERT INTO public.question (id, text, points, number, question_type, lesson_id, ordinal_number) VALUES (7, 'The body of main function is enclosed by parenthesis.', 1, 1, 0, 4, 0);
INSERT INTO public.question (id, text, points, number, question_type, lesson_id, ordinal_number) VALUES (8, 'Header files have two types: system and programmer made.', 1, 1, 0, 4, 0);
INSERT INTO public.question (id, text, points, number, question_type, lesson_id, ordinal_number) VALUES (9, 'For input/output operations in C++ we use:', 1, 1, 0, 5, 0);
INSERT INTO public.question (id, text, points, number, question_type, lesson_id, ordinal_number) VALUES (10, 'What is a variable in programming language?', 1, 1, 0, 6, 0);
INSERT INTO public.question (id, text, points, number, question_type, lesson_id, ordinal_number) VALUES (11, 'Variable identifier in programming language', 1, 1, 0, 7, 0);
...
-- TOPIC
-- -------------------------------------------------------------------------
INSERT INTO public.topic (id, name) VALUES (1, 'Algorithm');
INSERT INTO public.topic (id, name) VALUES (2, 'Matematics');
